...
const styles = StyleSheet.create({
  ...
  title: { color: color.textPrimary, fontFamily: font.sansSemibold, fontSize: textScale.lg, textAlign: 'left' },
  scroll: { paddingHorizontal: space.gutter, paddingBottom: space[10] },
  meta: { color: color.textSecondary, fontFamily: font.mono, fontSize: textScale.xs, marginBottom: space[1], textAlign: 'left' },
  count: { color: color.textPrimary, fontFamily: font.mono, fontSize: textScale.sm, marginTop: space[2], marginBottom: space[2], textAlign: 'left' },
  card: { backgroundColor: color.bgSurface, borderRadius: 12, padding: space[4], marginBottom: space[3] },
  slotName: { color: color.textPrimary, fontFamily: font.sansSemibold, fontSize: textScale.base, textAlign: 'left' },
  slotId: { color: color.textTertiary, fontFamily: font.mono, fontSize: textScale['2xs'], marginBottom: space[2], textAlign: 'left' },
  field: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 1 },
  fk: { color: color.textSecondary, fontFamily: font.mono, fontSize: textScale.xs, textAlign: 'left' },
  fv: { color: color.textPrimary, fontFamily: font.mono, fontSize: textScale.xs, textAlign: 'left' },
});
