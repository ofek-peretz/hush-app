...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: font.sansSemibold, fontSize: textScale['3xl'], letterSpacing: trackingPx(textScale['3xl'], tracking.display), color: color.textPrimary, lineHeight: textScale['3xl'] * 1.02 },
  intro: { marginTop: 12, fontFamily: font.sans, fontSize: textScale.md, lineHeight: 25, color: color.textSecondary, maxWidth: 340 },
  ...
  workoutName: { fontFamily: font.sansSemibold, fontSize: textScale.md, letterSpacing: trackingPx(textScale.md, tracking.tight), color: color.textPrimary },
  workoutGroups: { fontFamily: font.sansMedium, fontSize: textScale['2xs'], letterSpacing: trackingPx(textScale['2xs'], tracking.legend), color: color.textTertiary },
  ...
  liftName: { flex: 1, fontFamily: font.sans, fontSize: textScale.md, color: color.textPrimary },
  liftNameStrong: { fontFamily: font.sansSemibold },
  liftSecond: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginTop: 6 },

  sub: { fontFamily: font.mono, fontSize: textScale.sm, color: color.textMuted },
  subFrom: { color: color.textTertiary },
  subArrow: { color: color.textTertiary },
  subStrong: { fontFamily: font.monoSemibold, color: color.textPrimary },
  subDot: { color: color.textTertiary },
  newExercise: { fontFamily: font.sans, fontSize: textScale.sm, color: color.textTertiary },

  loadCluster: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  loadLine: { fontFamily: font.mono, fontSize: textScale.md, color: color.textMuted },
  loadFrom: { fontFamily: font.mono, fontSize: textScale.sm, color: color.textTertiary },
  arrow: { color: color.textTertiary, fontSize: textScale.sm },
  loadTo: { fontFamily: font.monoSemibold, fontSize: textScale.lg },
  loadPlain: { fontFamily: font.mono, fontSize: textScale.md, color: color.textPrimary },
  loadSwap: { fontFamily: font.monoSemibold, fontSize: textScale.lg, color: color.textPrimary },
  kg: { fontFamily: font.mono, fontSize: textScale.xs, color: color.textMuted },
  ...
  swapBadgeText: { fontFamily: font.sansSemibold, fontSize: textScale['2xs'], letterSpacing: trackingPx(textScale['2xs'], tracking.legend), color: color.accentText },
