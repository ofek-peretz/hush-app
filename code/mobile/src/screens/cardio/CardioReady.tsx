...
const styles = StyleSheet.create({
  ...
  bracketDot: { position: 'absolute', left: 26, top: 5, width: 12, height: 12, borderRadius: 6, backgroundColor: signal[0] },
  title: { fontFamily: font.serif, fontSize: 54, lineHeight: 56, color: stageC.ink0, textAlign: 'center' },
  sub: { fontFamily: font.serif, fontStyle: 'italic', fontSize: textScale.lg, lineHeight: 27, color: stageC.ink1, textAlign: 'center', maxWidth: 260 },
  footer: { paddingHorizontal: 26, paddingBottom: 16 },
});
