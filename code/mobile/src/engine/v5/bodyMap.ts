 ...
 *
 * WIRED: `screens/profile/BodyMapEdit` asks this before it accepts an OFF toggle, so a muscle she
 * has actually trained gets the one question and a muscle she never trained is turned off in
 * silence. (This header used to say "deliberately not wired"; the screen shipped and the note did
 * not keep up — the code is the authority.)
 */
