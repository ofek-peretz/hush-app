...
const styles = StyleSheet.create({
  ...
  chipText: { fontFamily: font.sansMedium, fontSize: 13.5, letterSpacing: trackingPx(9.5, tracking.legend), color: color.textMuted, textTransform: 'uppercase', textAlign: 'left' },
});
