 ...
 * accessibilityLabel. Settles 1px on press; `bordered` adds a hairline + surface;
 * `onStage` inverts for the live workout.
 */
...
const styles = StyleSheet.create({
  ...
  pressed: { backgroundColor: color.fillSubtle, transform: [{ translateY: 1 }] },
  onStagePressed: { backgroundColor: stageC[1], transform: [{ translateY: 1 }] },
